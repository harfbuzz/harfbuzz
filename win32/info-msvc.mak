...
BUILD_TYPE = release (using NDEBUG)
!else
BUILD_TYPE = release (using HB_NDEBUG)
!endif
!else
!if "$(VSVER)" != "9"
BUILD_TYPE = debug (using HB_DEBUG)
!else
BUILD_TYPE = debug
!endif
!endif
...
help:
	...
	@echo MinGW builds.
	@echo.
	@echo RELEASE_USE_NDEBUG
	@echo For release builds, further reduce the amount of debug code built into
	@echo the resulting build, for optimized production builds.
	@echo This option has no effect on debug builds.
	@echo.
