...
{..\..\src\}.cc{$(CFG)\$(PLAT)\harfbuzz\}.obj::
	$(CXX) $(CFLAGS) $(HB_DEFINES) $(HB_CFLAGS) /Fo$(CFG)\$(PLAT)\harfbuzz\ /c @<<
$<
<<
...
{..\..\src\}.cc{$(CFG)\$(PLAT)\harfbuzz-icu\}.obj::
	$(CXX) $(CFLAGS) $(HB_CFLAGS) $(HB_ICU_CFLAGS) /Fo$(CFG)\$(PLAT)\harfbuzz-icu\ /c @<<
$<
<<

{..\..\util\}.cc{$(CFG)\$(PLAT)\util\}.obj::
	$(CXX) $(CFLAGS) $(HB_DEFINES) $(HB_CFLAGS) /FIhb-utils-msvc.h /Fo$(CFG)\$(PLAT)\util\ /c @<<
$<
<<
...
$(HARFBUZZ_DLL_FILENAME).dll: config.h $(harfbuzz_dll_OBJS) $(CFG)\$(PLAT)\harfbuzz\harfbuzz.def
	link /DLL $(LDFLAGS) $(HB_DEP_LIBS) /def:$(CFG)\$(PLAT)\harfbuzz\harfbuzz.def /implib:$(CFG)\$(PLAT)\harfbuzz.lib -out:$@ @<<
$(harfbuzz_dll_OBJS)
<<
	@-if exist $@.manifest mt /manifest $@.manifest /outputresource:$@;2

$(HARFBUZZ_ICU_DLL_FILENAME).dll: $(CFG)\$(PLAT)\harfbuzz.lib $(harfbuzz_icu_OBJS) $(CFG)\$(PLAT)\harfbuzz-icu\harfbuzz-icu.def
	link /DLL $(LDFLAGS) $(CFG)\$(PLAT)\harfbuzz.lib $(HB_ICU_DEP_LIBS) /def:$(CFG)\$(PLAT)\harfbuzz-icu\harfbuzz-icu.def /implib:$(CFG)\$(PLAT)\harfbuzz-icu.lib -out:$@ @<<
$(harfbuzz_icu_OBJS)
<<
	@-if exist $@.manifest mt /manifest $@.manifest /outputresource:$@;2

$(HARFBUZZ_GOBJECT_DLL_FILENAME).dll: $(CFG)\$(PLAT)\harfbuzz.lib $(harfbuzz_gobject_OBJS) $(CFG)\$(PLAT)\harfbuzz-gobject\harfbuzz-gobject.def
	link /DLL $(LDFLAGS) $(CFG)\$(PLAT)\harfbuzz.lib $(HB_GOBJECT_DEP_LIBS) /def:$(CFG)\$(PLAT)\harfbuzz-gobject\harfbuzz-gobject.def /implib:$(CFG)\$(PLAT)\harfbuzz-gobject.lib -out:$@ @<<
...
# Rule for generating .def files
$(CFG)\$(PLAT)\harfbuzz\harfbuzz.def: ..\..\src\harfbuzz.symbols $(CFG)\$(PLAT)\harfbuzz
	@echo EXPORTS > $@
	$(CC) /EP $(HB_DEFINES) /FIconfig.h /I. ..\..\src\harfbuzz.symbols >> $@

$(CFG)\$(PLAT)\harfbuzz-icu\harfbuzz-icu.def: ..\..\src\harfbuzz-icu.symbols $(CFG)\$(PLAT)\harfbuzz-icu
	@echo EXPORTS > $@
	$(CC) /EP ..\..\src\harfbuzz-icu.symbols >> $@

$(CFG)\$(PLAT)\harfbuzz-gobject\harfbuzz-gobject.def: ..\..\src\harfbuzz-gobject.symbols $(CFG)\$(PLAT)\harfbuzz-gobject
	@echo EXPORTS > $@
	$(CC) /EP ..\..\src\harfbuzz-gobject.symbols >> $@
...
$(CFG)\$(PLAT)\harfbuzz-gobject\hb-gobject-structs.obj:	$(CFG)\$(PLAT)\harfbuzz-gobject $(HB_GOBJECT_ENUM_GENERATED_SOURCES)
	$(CXX) $(CFLAGS) $(HB_DEFINES) $(HB_CFLAGS) /I$(CFG)\$(PLAT)\harfbuzz-gobject /Fo$(CFG)\$(PLAT)\harfbuzz-gobject\ /c @<<
...
clean:
	...
	@-if exist $(CFG)\$(PLAT)\harfbuzz-gobject del /f /q $(CFG)\$(PLAT)\harfbuzz-gobject\*.def
	@-if exist $(CFG)\$(PLAT)\harfbuzz-gobject del /f /q $(CFG)\$(PLAT)\harfbuzz-gobject\*.obj
	@-if exist $(CFG)\$(PLAT)\harfbuzz-icu del /f /q $(CFG)\$(PLAT)\harfbuzz-icu\*.def
	@-if exist $(CFG)\$(PLAT)\harfbuzz-icu del /f /q $(CFG)\$(PLAT)\harfbuzz-icu\*.obj
	@-del /f /q $(CFG)\$(PLAT)\harfbuzz\*.def
