...
!if [call create-lists.bat header hb_srcs.mak HB_HDRS]
!endif
...
!if [call create-lists.bat header hb_srcs.mak HB_SRCS]
!endif
...
!if [call create-lists.bat header hb_srcs.mak HB_GOBJECT_SRCS]
!endif

!if [for %s in ($(HB_GOBJECT_SOURCES) $(HB_GOBJECT_STRUCTS_HDRS)) do @call create-lists.bat file hb_srcs.mak ..\..\src\%s]
!endif
