...
echo "Building debug version without optimization"
emcc .libs/libharfbuzz.dylib hb-ucdn/.libs/ucdn.o --post-js post.js -o harfbuzz-unoptimized.js .libs/libharfbuzz.dylib hb-ucdn/.libs/ucdn.o

echo "Building production version with optimization"
