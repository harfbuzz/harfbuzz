...
time emcc .libs/libharfbuzz.dylib hb-ucdn/.libs/ucdn.o --post-js post.js -o harfbuzz-unoptimized.js -O0 -s "ALLOW_MEMORY_GROWTH=1" -s "EXPORTED_FUNCTIONS=$EXPORTED_FUNCTIONS"

echo "Building debug version $VERSION with little optimization, no typed arrays"
time emcc .libs/libharfbuzz.dylib hb-ucdn/.libs/ucdn.o --post-js post.js -o harfbuzz-untyped-unoptimized.js -O0 -s "USE_TYPED_ARRAYS=0" -s "ALLOW_MEMORY_GROWTH=1" -s "EXPORTED_FUNCTIONS=$EXPORTED_FUNCTIONS"
